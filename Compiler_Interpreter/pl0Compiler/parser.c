...
const tBog gStatement[]={
/* 0*/ {BgMo,  {(ul)mcIdent},          NULL, 7, 1},
/* 1*/ {BgSy, {(ul)zIF},        NULL, 8, 2},
/* 2*/ {BgSy, {(ul)zWHL},     NULL, 9, 3},
/* 3*/ {BgSy,  {(ul)zBGN},    NULL, 16, 4},
/* 4*/ {BgSy,  {(ul)zCLL},    NULL, 10, 5},
/* 5*/ {BgSy,  {(ul)'?'},       NULL, 11, 6},
/* 6*/ {BgSy,  {(ul)'!'},      NULL, 12, 0},

/* 7*/ {BgSy,  {(ul)zERG}, NULL, 13, 0},
...
/* 14*/ {BgSy, {(ul)zTHN},  NULL, 18, 0},
/* 15*/ {BgSy, {(ul)zDO},    NULL, 19, 0},
/* 16*/ {BgGr, {(ul)gStatement},    NULL, 17, 20},
/* 17*/ {BgSy, {(ul)';'},    NULL, 16, 20},

/* 18*/ {BgGr, {(ul)gStatement},     NULL, 21, 0},
/* 19*/ {BgGr, {(ul)gStatement},    NULL, 21, 0},
/* 20*/ {BgSy, {(ul)zEND},  NULL, 21, 0},
/* 21*/ {BgEn, {(ul)0},   NULL, 0, 0}
};

const tBog gBlock[]={
/* 0*/ {BgSy,  {(ul)zCST}, NULL, 2, 1},
/* 1*/ {BgNl,  {(ul)NULL},   NULL, 7, 0},
