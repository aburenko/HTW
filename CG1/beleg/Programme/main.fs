...
uniform float sunHight;
uniform bool richBool;
...
// Ambient
            { false, true, false, vec3(0,0,0), vec3(1,1,1),
               vec3(4, 4.0, 4.0), vec3(1, 1.0, 1.0), 180, 0,
               1,0,0  },
// Richtungslicht
            { richBool, false, false, sunColor, vec3(1, 1, 1),
               vec3(4, 4.0, 4.0), vec3(1, 1.0, 1.0), 180, 0,
               1,0,0  },
// Spotlicht
            { spotBool, false, true, vec3(0, 0, 0), vec3(1,1,1),
               vec3(0, sunHight, 3.0), vec3(0, 0, -1), 0.9, 100,
               1,0.05,0.1 }
};
