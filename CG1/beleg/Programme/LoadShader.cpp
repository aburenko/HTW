...
GLuint loadShaders(const char* vertexFilePath, const char* fragmentFilePath,
	...
	if (vsavailable){
		printf("compiling vertex shader: %s", vertexFilePath);
	...
	if (fsavailable){
		printf("compiling fragment shader: %s", fragmentFilePath);
	...
	if (gsavailable){
		printf("compiling geometry shader: %s", geometryFilePath);
	...
	if (tcsavailable){
		printf("compiling tesscontrol shader: %s", tesscontrolFilePath);
	...
	if (tesavailable){
		printf("compiling tessevaluation shader: %s", tessevaluationFilePath);
	...
	if (cosavailable){
		printf("compiling compute shader: %s", computeFilePath);
